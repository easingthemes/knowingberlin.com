...
class notamagic_recent_posts_slider extends WP_Widget
{
    ...
    function widget($args , $instance) {
        ...
        $limit = isset($instance['limit']) ? esc_html( $instance['limit'] ) : 20;
            ...
            <ul class="slides">
                <?php
                  ...
                  if ($featured_query->have_posts()) : 
                    $featuredimages_number = 0;
                    while($featured_query->have_posts()) : 
                      $featured_query->the_post();
                      $featuredimage_values = get_post_custom_values('show_featured_image', get_the_ID());
                      $featuredimages_number = $featuredimage_values[0] ? $featuredimages_number + 1 : $featuredimages_number;
                      ?>

                          <?php if(get_the_content() != '' && $featuredimage_values[0] && $featuredimages_number < 5) : ?>
